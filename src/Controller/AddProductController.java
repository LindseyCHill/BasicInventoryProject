...
public class AddProductController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        int tempId = SharedData.getProductId();
    ...
    /**
     * This method returns the user to the Main view without adding the product.
     * @param event - the cancel button is pressed
     * @throws Exception from FXMLLoader.
     */

    public void cancelAddProductTrigger(ActionEvent event) throws Exception {
    ...
    /**
     * This method returns the user to the Main view after adding the product if the information is valid.
     * @param event - the save button is pressed
     * @throws Exception from FXMLLoader.
     */

    public void commitAddProductTrigger(ActionEvent event) throws Exception{
        if(SharedData.validateProduct(idTextBox.getText(), nameTextBox.getText(), priceTextBox.getText(), stockTextBox.getText(), minTextBox.getText(), maxTextBox.getText())){
    ...
    /**
     * This method creates the new product with the user input information and adds it to the Inventory list of products.
     */
